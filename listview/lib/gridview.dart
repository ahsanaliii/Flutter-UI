      ...
      body: SafeArea(
        child: GridView.extent(
          ...
          children: [
            ...
            Container(
              decoration:
                  const BoxDecoration(color: Color.fromARGB(255, 116, 57, 52)),
            ),
            Container(
              decoration:
                  const BoxDecoration(color: Color.fromARGB(255, 8, 3, 2)),
            ),
            Container(
              decoration:
                  const BoxDecoration(color: Color.fromARGB(255, 128, 51, 46)),
            ),
            Container(
              decoration:
                  const BoxDecoration(color: Color.fromARGB(255, 10, 25, 107)),
            ),
            Container(
              decoration:
                  const BoxDecoration(color: Color.fromARGB(255, 14, 155, 78)),
            ),
            Container(
              decoration:
                  const BoxDecoration(color: Color.fromARGB(255, 141, 35, 8)),
            ),
          ],
        ),
